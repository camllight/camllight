...
\\{caml-mode-map}"
  ...
  ;itz 03-25-96
  (setq before-change-functions 'caml-before-change-functions)
...
(defun caml-before-change-functions (begin end)
  ...
  (let ((orig-function (default-value 'before-change-functions)))
