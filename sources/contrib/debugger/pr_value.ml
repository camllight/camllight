...
let rec print_val prio obj ty =
  ...
  | Tconstr(cstr, ty_list) ->
      if same_type_constr cstr constr_type_list then begin
        ...
        in
          ...
          let rec print_conses cons =
            if value_tag cons == 0 then
              ...
              print_val 0 (value_nth_field cons 0) ty_arg;
	      let next_obj = value_nth_field cons 1 in
                if value_tag next_obj == 0 then
                  print_string "]"
                else begin
                  print_string "; "; print_conses next_obj
                end
            end
          in print_conses obj
        ...
        in
          print_string "[|";
          for i = 0 to value_size obj - 1 do
            if i > 0 then print_string "; ";
            print_val 0 (value_nth_field obj i) ty_arg
          done;
          print_string "|]"
      end else
        try
...
and print_concrete_type prio obj cstr ty ty_list =
  ...
  | Variant_type constr_list ->
      ...
      begin try
        ...
        | Constr_regular ->
            ...
            print_constr constr;
            print_string " ";
            print_val 2 (value_nth_field obj 0) ty_arg;
            if prio > 1 then print_string ")"
  ...
  | Record_type label_list ->
      ...
      let print_field lbl =
        ...
        print_val 0 (value_nth_field obj lbl.info.lbl_pos) ty_arg in
...
and print_val_list prio obj ty_list =
  ...
  | [ty] ->
       print_val prio (value_nth_field obj i) ty
  | ty::ty_list ->
       print_val prio (value_nth_field obj i) ty;
       print_string ", ";
