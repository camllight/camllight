...
and rewrite_expr e =
  ...
  with 
     ...
     | Zfor (_, e1, e2, _, e3) -> 
      	 ...
      	 rewrite_expr e3
     | Zsequand (e1, e2) -> rewrite_expr e1; rewrite_expr e2
     | Zsequor (e1, e2) -> rewrite_expr e1; rewrite_expr e2
...
let rec rewrite_impl_phrase impl =
  ...
  with Zexpr e -> rewrite_expr e
     ...
     | Ztypedef decl -> type_typedecl impl.im_loc decl; ()
     | Zexcdef decl -> type_excdecl impl.im_loc decl; ()
