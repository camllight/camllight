...
\def\endpc{\endlist}
\def\pcbase{\versionspecific{86}}
\def\endpcbase{\endlist}
\def\pcthree{\versionspecific{386}}
\def\endpcthree{\endlist}
...
\def\endprecedences{\hline\end{tabular}\end{center}}
\def\prec#1#2{#1 & #2 \\}
